...
public class ParticipanteControl {
    ...
    public void previousPag() {
        table.clearTable();
        List<Participante> cat = persistence.listar(((currentPage * rowsPerPage) - (rowsPerPage + rowsPerPage)), rowsPerPage);
    ...
    public void nextPag() {
        table.clearTable();
        List<Participante> cat = persistence.listar((currentPage * rowsPerPage), rowsPerPage);
        for (Participante categoria : cat) {
            table.addRow(categoria);
        }
        currentPage++;
    ...
    public void lastPage() {
        table.clearTable();
        List<Participante> cat = persistence.listar((totalPage * rowsPerPage) - rowsPerPage, rowsPerPage);
        for (Participante categoria : cat) {
            table.addRow(categoria);
        }
