 ...
 * @author ACER
 */
public class TelaList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerenciamento de Categoria de Produtos");
        ...
        comboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2", "4", "6", "8", "10" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
