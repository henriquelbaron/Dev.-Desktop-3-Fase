 ...
 * @author ACER
 */
public class CRUDParticipantesJFrame extends javax.swing.JFrame {

    /**
     * Creates new form TelaPrincipal
     */
    private ParticipanteControl control;
//    private ParticipanteTable table;

    public CRUDParticipantesJFrame() {
        initComponents();
        control = new ParticipanteControl();
//        table = new ParticipanteTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUDParticipantesJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDParticipantesJFrame().setVisible(true);
            }
        });
    }
